...
(* OASIS_START *)
(* DO NOT EDIT (digest: 7c0243cb1cbb09399ec932cfd3db82ae) *)
(*
...
let setup_t =
  {
                 ...
                 ({
                   ...
                   },
                   {
                      ...
                      lib_internal_modules =
                        ["Channel"; "Monitor"; "Multiparty_base"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt =
                        [(OASISExpr.EBool true, ["-rectypes"; "-linkall"])];
                      bs_nativeopt =
                        [(OASISExpr.EBool true, ["-rectypes"; "-linkall"])]
                   },
                   {
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "n\246D\228x\246\217\218\143\238g\163\246\182\130H";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
