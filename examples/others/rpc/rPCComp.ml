...
type ('c_S1, 'c_S2, 'c_S3) rPCComp_C = ('c_S1, 'c_S2, 'c_S3) rPCComp_C_1
and ('c_S1, 'c_S2, 'c_S3) rPCComp_C_1 =
  [`send of [`S1 of 'c_S1 * [`_1 of unit data *
    [`recv of [`S1 of 'c_S1 * [`_1a of unit data *
      [`close] sess]]] sess]]]
type ('c_C, 'c_S2, 'c_S3) rPCComp_S1 = ('c_C, 'c_S2, 'c_S3) rPCComp_S1_1
and ('c_C, 'c_S2, 'c_S3) rPCComp_S1_1 =
...
type ('c_C, 'c_S1, 'c_S3) rPCComp_S2 = ('c_C, 'c_S1, 'c_S3) rPCComp_S2_1
and ('c_C, 'c_S1, 'c_S3) rPCComp_S2_1 =
  [`recv of [`S1 of 'c_S1 * [`_2 of unit data *
    [`send of [`S1 of 'c_S1 * [`_2a of unit data *
      [`close] sess]]] sess]]]
type ('c_C, 'c_S1, 'c_S2) rPCComp_S3 = ('c_C, 'c_S1, 'c_S2) rPCComp_S3_1
and ('c_C, 'c_S1, 'c_S2) rPCComp_S3_1 =
...
type rPCComp = ShmemMPSTChanenl__ of Shmem.MPSTChannel.t
let create_shmem_channel : unit -> rPCComp = fun () ->
  ShmemMPSTChanenl__(Shmem.MPSTChannel.create ~acceptor_role:"role_C" ~connector_roles:["role_S1";; "role_S2"; "role_S3"])


module C = struct
  let initiate_shmem : 'c. rPCComp -> ('c, 'c, Shmem.Raw.t rPCComp_C sess) monad = fun (ShmemMPSTChanenl__(c)) ->
...
module S1 = struct
  let initiate_shmem : 'c. rPCComp -> ('c, 'c, Shmem.Raw.t rPCComp_S1 sess) monad = fun (ShmemMPSTChanenl__(c)) ->
...
module S2 = struct
  let initiate_shmem : 'c. rPCComp -> ('c, 'c, Shmem.Raw.t rPCComp_S2 sess) monad = fun (ShmemMPSTChanenl__(c)) ->
...
module S3 = struct
  let initiate_shmem : 'c. rPCComp -> ('c, 'c, Shmem.Raw.t rPCComp_S3 sess) monad = fun (ShmemMPSTChanenl__(c)) ->
