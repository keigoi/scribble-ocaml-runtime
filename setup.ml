...
(* OASIS_START *)
(* DO NOT EDIT (digest: ce69000f626be944ca0af4fe1f4d17c3) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          alpha_features = [];
          beta_features = [];
          name = "scribble-ocaml-runtime";
          license_file = None;
          copyrights = [];
          maintainers = [];
          authors = ["Keigo Imai"];
          homepage = Some "https://github.com/keigoi/scribble-ocaml-runtime";
          bugreports = None;
          synopsis = "A runtime for scribble-ocaml";
          description = None;
          tags = [];
          categories = [];
          files_ab = [];
          sections =
            [
               Library
                 ({
                     cs_name = "scribble-ocaml-runtime";
                   ...
                   {
                      lib_modules = ["Multiparty"];
                      lib_pack = false;
                      lib_internal_modules =
                        ["Channel"; "Monitor"; "Unsafe"; "Multiparty_base"];
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "scribble-ocaml-runtime";
                      ...
                      bs_dlllib = [(OASISExpr.EBool true, [])];
                      bs_dllpath = [(OASISExpr.EBool true, [])];
                      bs_byteopt = [(OASISExpr.EBool true, ["-linkall"])];
                      bs_nativeopt = [(OASISExpr.EBool true, ["-linkall"])]
                   },
                   {
                      exec_custom = false;
                      exec_main_is = "test_multiparty_base.ml"
                   })
            ];
     ...
     oasis_version = "0.4.8";
     oasis_digest = Some "\030W\207\247\220\011\198<\179\174\127]M\230F\209";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
