...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0f4e78fb10de209a9e1f8b0e1653089c) *)
(*
...
let setup_t =
  {
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Base"; "Endpoint"; "Session"; "Direct"];
                      lib_pack = true;
                      lib_internal_modules =
                        ["Channel"; "Dchannel"; "GHashtbl"; "Unsafe"];
               ...
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           InternalLibrary "scribble";
                           FindlibPackage ("lwt", None);
                           FindlibPackage ("lwt.unix", None);
                           FindlibPackage ("linocaml.lwt", None)
                        ];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_interface_patterns =
                        [
                   ...
                   {
                      lib_modules = ["Scribble_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "scribble";
     ...
     oasis_digest = Some "3\228Hh\014rH\220\1566\180\026\167\012N\203";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
