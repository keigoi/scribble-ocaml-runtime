...
let initiate_C : 'pre 'post. (travelAgency_Sec4,[`Explicit]) channel -> ('c, 'c, travelAgency_Sec4_C sess) monad =
  fun ch ->
  Internal.__initiate ~myname:"role_C" ch
let initiate_A : 'pre 'post. (travelAgency_Sec4,[`Explicit]) channel -> ('c, 'c, travelAgency_Sec4_A sess) monad =
  fun ch ->
  Internal.__initiate ~myname:"role_A" ch
let initiate_S : 'pre 'post. (travelAgency_Sec4,[`Explicit]) channel -> ('c, 'c, travelAgency_Sec4_S sess) monad =
  fun ch ->
