...
(* OASIS_START *)
(* DO NOT EDIT (digest: 48971ca6b1b2a04df2621d9d9b6d904d) *)
(*
...
let setup_t =
  {
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Base"; "Endpoint"; "Formatter"; "Session"; "Direct"
                        ];
                      lib_pack = true;
                      lib_internal_modules = ["Unsafe"];
     ...
     oasis_digest = Some "ÜCÁ\129\031\029SX\151Lå2Ï½\138è";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
